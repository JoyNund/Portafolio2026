...
const portfolioItems = [
    ...
    { type: 'image', src: 'img/lp1.webp', title: 'Controla.Digital SaaS', category: 'Web Developement' },
    ...
    { type: 'image', src: 'img/lp4.webp', title: 'Tienda de web apps', category: 'Web Developement' },
    { type: 'image', src: 'img/wing1.webp', title: 'Wingman ad', category: 'Advertising' },
    { type: 'image', src: 'img/lp3.webp', title: 'Landing Page Agente Inmobiliaria', category: 'Web Design' },
...
function loadPortfolioItems(count = itemsPerLoad) {
    ...
    itemsToLoad.forEach((item, index) => {
        ...
        if (item.type === 'image') {
           ...
           const cleanSrc = item.src.split('?')[0]; // por si viene con query params
           const isLandingPage = /^lp\d*\.webp$/.test(cleanSrc.split('/').pop());
